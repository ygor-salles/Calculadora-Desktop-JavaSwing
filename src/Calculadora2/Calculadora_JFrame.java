...
public class Calculadora_JFrame extends javax.swing.JFrame {
    ...
    private void jPanel1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPanel1KeyPressed
        ...
        else if (evt.getKeyCode() == 10) /* botão do teclado, enter */
            botaoIgual();
        else if (evt.getKeyCode() == 8) /* botão do teclado, backspeace */
            backspeace();
        
        //System.out.println(evt.getKeyCode()); /*Verificar que tipo de inteiro sai no java */
